x5engine.settings.imBlog = {
	...
	title_tag: 'Questions Assurance Temporaire - Tempo-assurance',
	...
	comment_type: 'both',
	approve_comments: 0,
	categories: ['Assurance temporaire', 'Information générale'],
	authors: [],
	posts: [],
	posts_cat: [],
	posts_author: [],
...
x5engine.settings.imBlog.posts['jj09duxz'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?vous-traversez-une-periode-difficile-et-vous-avez-ete-resilie-pour-non-paiement-de-prime,-puis-je-souscrire-",
		"speakable": {
		...
		"itemListElement": [
			{
				"@type": "ListItem",
				"name": "Questions Assurance Temporaire",
				"item": "http://192.168.1.146:8081/blog",
				"position": 1
			},
			{
				"@type": "ListItem",
				"name": "Août 2017",
				"item": "http://192.168.1.146:8081/blog/?month=201708",
				"position": 2
			},
			{
				"@type": "ListItem",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				...
				"item": "http://192.168.1.146:8081/blog/?category=Assurance temporaire",
				"position": 2
			},
			{
				"@type": "ListItem",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'jj09duxz';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'jj09duxz';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'jj09duxz';
x5engine.settings.imBlog.posts_slug['vous-traversez-une-periode-difficile-et-vous-avez-ete-resilie-pour-non-paiement-de-prime,-puis-je-souscrire-'] = 'jj09duxz';
...
x5engine.settings.imBlog.posts['jfv0ey90'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?vehicule-immobilise-par-la-police-et-mise-en-fourriere-pour-defaut-d--assurance",
		"image": "http://192.168.1.146:8081/images\\mise-fourriere.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
	...
	},
	{
		...
		"itemListElement": [
			...
			},
			{
				...
				"item": "http://192.168.1.146:8081/blog/?category=Information générale",
				"position": 2
			},
			{
				"@type": "ListItem",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'jfv0ey90';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'jfv0ey90';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'jfv0ey90';
x5engine.settings.imBlog.posts_slug['vehicule-immobilise-par-la-police-et-mise-en-fourriere-pour-defaut-d--assurance'] = 'jfv0ey90';
...
x5engine.settings.imBlog.posts['kv6thljn'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?ramener-un-camion-achete-dans-son-pays-",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'kv6thljn';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'kv6thljn';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'kv6thljn';
x5engine.settings.imBlog.posts_slug['ramener-un-camion-achete-dans-son-pays-'] = 'kv6thljn';
...
x5engine.settings.imBlog.posts['t43smc0r'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?quels-sont-les-vehicules-qui-peuvent-etre-couverts-par-une-assurance-auto-tempo--",
		"image": "http://192.168.1.146:8081/images\\premier-ensemble-de-vehicules.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 't43smc0r';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 't43smc0r';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 't43smc0r';
x5engine.settings.imBlog.posts_slug['quels-sont-les-vehicules-qui-peuvent-etre-couverts-par-une-assurance-auto-tempo--'] = 't43smc0r';
...
x5engine.settings.imBlog.posts['7oo7d3r2'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?quels-sont-les-pays-couverts-par-la-garantie",
		"image": "http://192.168.1.146:8081/images\\pays-monde-continents.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = '7oo7d3r2';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = '7oo7d3r2';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = '7oo7d3r2';
x5engine.settings.imBlog.posts_slug['quels-sont-les-pays-couverts-par-la-garantie'] = '7oo7d3r2';
...
x5engine.settings.imBlog.posts['ifg9f26r'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?quelles-sont-les-garanties-de-mon-contrat--",
		"image": "http://192.168.1.146:8081/images\\rc-assistance.png",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'ifg9f26r';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'ifg9f26r';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'ifg9f26r';
x5engine.settings.imBlog.posts_slug['quelles-sont-les-garanties-de-mon-contrat--'] = 'ifg9f26r';
...
x5engine.settings.imBlog.posts['om68cr07'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?quel-site-pour-souscrire-immediatement-en-ligne",
		"image": "http://192.168.1.146:8081/images\\Paiement_Securise.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'om68cr07';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'om68cr07';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'om68cr07';
x5engine.settings.imBlog.posts_slug['quel-site-pour-souscrire-immediatement-en-ligne'] = 'om68cr07';
...
x5engine.settings.imBlog.posts['io7avank'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?que-faire-en-cas-d-accident-de-voiture--",
		"image": "http://192.168.1.146:8081/images\\constat-amiable-accident.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'io7avank';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'io7avank';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'io7avank';
x5engine.settings.imBlog.posts_slug['que-faire-en-cas-d-accident-de-voiture--'] = 'io7avank';
...
x5engine.settings.imBlog.posts['xfes2m0j'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?qu-est-ce-que-la-responsabilite-civile-",
		"image": "http://192.168.1.146:8081/images\\rc-auto.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'xfes2m0j';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'xfes2m0j';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'xfes2m0j';
x5engine.settings.imBlog.posts_slug['qu-est-ce-que-la-responsabilite-civile-'] = 'xfes2m0j';
...
x5engine.settings.imBlog.posts['a167lwmy'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?puis-je-regler-en-ligne-en-toute-securite-",
		"image": "http://192.168.1.146:8081/images\\paiement-en-ligne.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'a167lwmy';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'a167lwmy';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'a167lwmy';
x5engine.settings.imBlog.posts_slug['puis-je-regler-en-ligne-en-toute-securite-'] = 'a167lwmy';
...
x5engine.settings.imBlog.posts['o5wx88sl'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?pourquoi-une-assurance-auto-temporaire--",
		"image": "http://192.168.1.146:8081/images\\pourquoi.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'o5wx88sl';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'o5wx88sl';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'o5wx88sl';
x5engine.settings.imBlog.posts_slug['pourquoi-une-assurance-auto-temporaire--'] = 'o5wx88sl';
...
x5engine.settings.imBlog.posts['4tm0vbfa'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?soucrire-avec-un-permis-de-conduire-et-carte-grise-hors-union-europeenne--",
		"image": "http://192.168.1.146:8081/images\\douane.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = '4tm0vbfa';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = '4tm0vbfa';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = '4tm0vbfa';
x5engine.settings.imBlog.posts_slug['soucrire-avec-un-permis-de-conduire-et-carte-grise-hors-union-europeenne--'] = '4tm0vbfa';
...
x5engine.settings.imBlog.posts['kyrkj9ah'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?peut-on-resilier-un-contrat-auto-tempo--",
		"image": "http://192.168.1.146:8081/images\\annulation_9b934jzr.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'kyrkj9ah';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'kyrkj9ah';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'kyrkj9ah';
x5engine.settings.imBlog.posts_slug['peut-on-resilier-un-contrat-auto-tempo--'] = 'kyrkj9ah';
...
x5engine.settings.imBlog.posts['deqiqqcm'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?la-carte-grise-est-barree--",
		"image": "http://192.168.1.146:8081/images\\carte-grise-barree.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'deqiqqcm';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'deqiqqcm';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'deqiqqcm';
x5engine.settings.imBlog.posts_slug['la-carte-grise-est-barree--'] = 'deqiqqcm';
...
x5engine.settings.imBlog.posts['d1m9eirp'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?la-carte-grise-n-est-pas-a-mon-nom--",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'd1m9eirp';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'd1m9eirp';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'd1m9eirp';
x5engine.settings.imBlog.posts_slug['la-carte-grise-n-est-pas-a-mon-nom--'] = 'd1m9eirp';
...
x5engine.settings.imBlog.posts['76sy9ovz'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?peut-on-faire-une-assurance-provisoire-24h-24-et-7j-7--",
		"image": "http://192.168.1.146:8081/images\\jour-nuit.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = '76sy9ovz';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = '76sy9ovz';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = '76sy9ovz';
x5engine.settings.imBlog.posts_slug['peut-on-faire-une-assurance-provisoire-24h-24-et-7j-7--'] = '76sy9ovz';
...
x5engine.settings.imBlog.posts['ppezxr8o'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?permis-etranger-pour-une-assurance-de-courte-duree--",
		"image": "http://192.168.1.146:8081/images\\Permis-etranger.png",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'ppezxr8o';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'ppezxr8o';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'ppezxr8o';
x5engine.settings.imBlog.posts_slug['permis-etranger-pour-une-assurance-de-courte-duree--'] = 'ppezxr8o';
...
x5engine.settings.imBlog.posts['nkrjfkr4'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?peut-on-annuler-un-contrat--",
		"image": "http://192.168.1.146:8081/images\\annulation_9b934jzr.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'nkrjfkr4';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'nkrjfkr4';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'nkrjfkr4';
x5engine.settings.imBlog.posts_slug['peut-on-annuler-un-contrat--'] = 'nkrjfkr4';
...
x5engine.settings.imBlog.posts['3p46pgxw'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?l-assurance-auto-temporaire-pour-qui--",
		"image": "http://192.168.1.146:8081/images\\groupe_humain.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = '3p46pgxw';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = '3p46pgxw';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = '3p46pgxw';
x5engine.settings.imBlog.posts_slug['l-assurance-auto-temporaire-pour-qui--'] = '3p46pgxw';
...
x5engine.settings.imBlog.posts['q7hbjrbe'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?est-ce-que-l-attestation-d-assurance-provisoire-que-j-ai-telechargee-est-valable-pour-circuler--",
		"image": "http://192.168.1.146:8081/images\\garantie_couleur.png",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'q7hbjrbe';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'q7hbjrbe';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'q7hbjrbe';
x5engine.settings.imBlog.posts_slug['est-ce-que-l-attestation-d-assurance-provisoire-que-j-ai-telechargee-est-valable-pour-circuler--'] = 'q7hbjrbe';
...
x5engine.settings.imBlog.posts['kvz1jy7n'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?comment-souscrire-en-ligne--",
		"image": "http://192.168.1.146:8081/images\\assurance_camping-car.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = 'kvz1jy7n';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'kvz1jy7n';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'kvz1jy7n';
x5engine.settings.imBlog.posts_slug['comment-souscrire-en-ligne--'] = 'kvz1jy7n';
...
x5engine.settings.imBlog.posts['5uli40tu'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?assurance-temporaire",
		"image": "http://192.168.1.146:8081/images\\calendrier_1jour.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Assurance temporaire'] == null) x5engine.settings.imBlog.posts_cat['Assurance temporaire'] = [];
x5engine.settings.imBlog.posts_cat['Assurance temporaire'][x5engine.settings.imBlog.posts_cat['Assurance temporaire'].length] = '5uli40tu';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = '5uli40tu';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = '5uli40tu';
x5engine.settings.imBlog.posts_slug['assurance-temporaire'] = '5uli40tu';
...
x5engine.settings.imBlog.posts['foadc224'] = {
	...
	rich_data_type: [
	{
		...
		"mainEntityOfPage": "http://192.168.1.146:8081/blog/?combien-de-temps-faut-il-pour-etre-assure-",
		"image": "http://192.168.1.146:8081/images\\calendrier_montre.jpg",
		"speakable": {
			"@type": "SpeakableSpecification",
			"xpath": [
				"/html/head/title",
...
if (x5engine.settings.imBlog.posts_cat['Information générale'] == null) x5engine.settings.imBlog.posts_cat['Information générale'] = [];
x5engine.settings.imBlog.posts_cat['Information générale'][x5engine.settings.imBlog.posts_cat['Information générale'].length] = 'foadc224';
if (x5engine.settings.imBlog.posts_author[''] == null) x5engine.settings.imBlog.posts_author[''] = [];
x5engine.settings.imBlog.posts_author[''][x5engine.settings.imBlog.posts_author[''].length] = 'foadc224';
if (x5engine.settings.imBlog.posts_month['201708'] == null) x5engine.settings.imBlog.posts_month['201708'] = [];
x5engine.settings.imBlog.posts_month['201708'][x5engine.settings.imBlog.posts_month['201708'].length] = 'foadc224';
x5engine.settings.imBlog.posts_slug['combien-de-temps-faut-il-pour-etre-assure-'] = 'foadc224';

// IDs summary
x5engine.settings.imBlog.posts_ids = ['jj09duxz', 'jfv0ey90', 'kv6thljn', 't43smc0r', '7oo7d3r2', 'ifg9f26r', 'om68cr07', 'io7avank', 'xfes2m0j', 'a167lwmy', 'o5wx88sl', '4tm0vbfa', 'kyrkj9ah', 'deqiqqcm', 'd1m9eirp', '76sy9ovz', 'ppezxr8o', 'nkrjfkr4', '3p46pgxw', 'q7hbjrbe', 'kvz1jy7n', '5uli40tu', 'foadc224'];
