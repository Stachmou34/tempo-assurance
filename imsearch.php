...
<html prefix="og: http://ogp.me/ns#" lang="fr-FR" dir="ltr">
	<head>
		<title>Recherche - Tempo-assurance</title>
		<meta charset="utf-8" />
		<!--[if IE]><meta http-equiv="ImageToolbar" content="False" /><![endif]-->
		<meta name="author" content="Australdev" />
		<meta property="og:locale" content="fr_FR" />
		<meta property="og:type" content="website" />
		<meta property="og:url" content="https://www.tempo-assurance.com/imsearch.php" />
		<meta property="og:title" content="Recherche" />
		<meta property="og:site_name" content="Tempo-assurance" />
		...
		<link rel="stylesheet" href="pcss/imsearch.css?2026-1-9-0-639154049297745744" media="screen,print" />
...
$(function () {$('#imHeader_imMenuObject_04_container ul li').not('.imMnMnSeparator').each(function () {    var $this = $(this), timeout = 0;    $this.on('mouseenter', function () {        if($(this).parents('#imHeader_imMenuObject_04_container-menu-opened').length > 0) return;         clearTimeout(timeout);        setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeIn(); }, 250);    }).on('mouseleave', function () {        if($(this).parents('#imHeader_imMenuObject_04_container-menu-opened').length > 0) return;         timeout = setTimeout(function () { $this.children('ul, .multiple-column').stop(false, false).fadeOut(); }, 250);    });});});
					...
					<main id="imContent">
						<a id="imGoToCont"></a>
						<div id="imSearchPage">
						<h1 id="imPgTitle">Résultat(s) de la recherche</h1>
						<?php
						$search = new imSearch();
